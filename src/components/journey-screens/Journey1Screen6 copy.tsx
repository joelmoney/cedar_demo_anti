...
interface Journey1Screen6Props {
  reducedMotion?: boolean;
  onNext?: () => void;
}

export function Journey1Screen6({ reducedMotion = false, onNext }: Journey1Screen6Props) {
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-[#64748B] text-sm">Paying today: $189.30</div>
                </div>
              </div>
              <ChevronDown
