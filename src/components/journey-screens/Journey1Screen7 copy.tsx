...
interface Journey1Screen7Props {
  reducedMotion?: boolean;
  onNext?: () => void;
}

export function Journey1Screen7({ reducedMotion = false, onNext }: Journey1Screen7Props) {
  return (
      ...
      <div className="min-h-full flex flex-col">
        ...
        <main className="flex-1 px-5 pt-8 pb-6 flex flex-col items-center">
          ...
          <p className="text-center text-[#475569] text-sm mb-2 px-4">
            ...
            <span className="font-bold text-[#1E293B]">$189.30 per month</span>. Your first payment will be processed on{' '}
