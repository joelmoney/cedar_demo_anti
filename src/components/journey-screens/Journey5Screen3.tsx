...
interface Journey5Screen3Props {
  reducedMotion?: boolean;
  onNext?: () => void;
}

export function Journey5Screen3({ reducedMotion = false, onNext }: Journey5Screen3Props) {
