...
interface Journey1Screen1Props {
  reducedMotion?: boolean;
  onNext?: () => void;
}

export function Journey1Screen1({ reducedMotion = false, onNext }: Journey1Screen1Props) {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: 'url(/images/J1_lockscreen.png)',
        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-4 py-3">
            ...
            <div className="text-[14px] text-slate-700 leading-relaxed mb-2">
              Hi Elias, your bill from ABC Health is now ready.
            </div>
            <div className="text-[14px] text-slate-700 mb-2">
              Click here to view: <a href="#" className="text-[#007AFF] font-medium">pay.abchealth.org</a>
            </div>
