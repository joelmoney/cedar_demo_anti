...
interface Journey4Screen1Props {
  reducedMotion?: boolean;
  onNext?: () => void;
}

export function Journey4Screen1({ reducedMotion = false, onNext }: Journey4Screen1Props) {
        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-4 py-3">
            ...
            <div className="text-[14px] text-slate-700 leading-relaxed mb-2">
              Hi Saffron, your bill from ABC Health is now ready.
            </div>
