...
export function Journey3Screen1({ reducedMotion = false, onNext }: Journey3Screen1Props) {
  return (
        ...
        <div className="max-w-lg text-left">
          ...
          >
            ...
            <p className="bodycopy mt-6 mb-6">
              This is the first full-image screen for Journey 3. Replace this content with your desired text and image.
            </p>
          </motion.div>
