...
interface Journey5Screen18Props {
  reducedMotion?: boolean;
  onNext?: () => void;
}

export function Journey5Screen18({ reducedMotion = false, onNext }: Journey5Screen18Props) {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: 'url(/images/J5_lockscreen.png)',
        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-4 py-3">
            ...
            <div className="text-[14px] text-slate-700 leading-relaxed">
              ABC Health: Your Medicaid application has been approved! There's nothing else you need to do. View details at pay.abchealth.org/12738372.
            </div>
          </div>
        </div>
      </motion.div>
