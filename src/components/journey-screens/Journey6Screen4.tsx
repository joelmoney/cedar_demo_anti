...
interface Journey6Screen4Props {
  reducedMotion?: boolean;
  onNext?: () => void;
}

export function Journey6Screen4({ reducedMotion = false, onNext }: Journey6Screen4Props) {
  return (
      ...
      <div className="min-h-full flex flex-col">
        ...
        <main className="flex-1 px-5 pt-8 pb-6 flex flex-col items-center">
          ...
          <p className="text-center text-[#475569] text-sm mb-2 px-4">
            ...
            <span className="font-bold text-[#1E293B]">$80.00</span>.
          </p>
