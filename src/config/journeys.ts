...
export const journeys: Journey[] = [
  ...
  },
  {
    ...
    leftPanelContent: [
      ...
      {
        headline: 'Sending a text with link',
        body: 'When Juliana receives the text, she taps the link and is taken straight to her bill.',
        instruction: 'Tap to continue',
      },
      {
        headline: 'Choosing HSA as her payment method',
        body: 'On the payment screen, Juliana sees HSA highlighted as a recommended option. She selects her HSA card, confident that she\'s using funds specifically set aside for healthcare rather than dipping into other savings.',
        instruction: 'Tap to continue',
      },
      {
        headline: 'Reviewing the payment details',
        body: 'Before confirming, Juliana reviews the total amount, the HSA source, and any relevant reference details tied to the visit. The layout is simple and familiar, designed to eliminate confusion and last‑minute second‑guessing.',
        instruction: 'Tap to continue',
      },
      {
        headline: 'Reviewing the payment details',
      ...
      {
        headline: 'Confirming payment and closing the loop',
        body: 'With a final tap, Juliana confirms the payment from her HSA. Cedar records the successful resolution, sends a confirmation for her records, and feeds that outcome back into Cedar Intelligence so future outreach to similar patients can follow the same high‑performing pattern.',
        instruction: 'Tap to finish',
      },
    ],
    steps: [
